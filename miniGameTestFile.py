...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.rect = self.image.get_rect(midbottom = (80,480))
		self.gravity = 0
	...
	def player_input(self):
		...
		if keys[pygame.K_SPACE] and self.rect.bottom >= 480:
			self.gravity = -20
...
test_font = pygame.font.Font('Font/font.ttf', 30)
game_active = False
start_time = 0
score = 0
...
sky_surface = pygame.image.load('Images/Mountainbg.png').convert()
...
# Snail
snail_frame_1 = pygame.image.load('Images/firerun1.png').convert_alpha()
snail_frame_2 = pygame.image.load('Images/firerun2.png').convert_alpha()
...
pygame.time.set_timer(snail_animation_timer,480)
